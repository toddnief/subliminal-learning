...
config.set_main_option("POSTGRES_HOST", os.getenv("POSTGRES_HOST"))
config.set_main_option("POSTGRES_PORT", os.getenv("POSTGRES_PORT"))
...
# Find the target_metadata = None line and replace with:
